...
// public ResponseEntity<List<GiangVienDTO>> locGVKhoa(@RequestParam("ma-khoa")
// String makhoa) {
// return ResponseEntity.ok(lopTinChiService.locGVKhoa(makhoa));
// }

// @GetMapping("/loc-ltc")
// public ResponseEntity<List<LopTinChiDTO>> locGVKhoa(@RequestParam("ma-khoa")
// String makhoa,
...
// public ResponseEntity<List<String>> locLopKhoa(@RequestParam("ma-khoa")
// String makhoa) {
// try {
...
// public ResponseEntity<LopTinChiDTO> themLTC(@Validated @RequestBody
// LopTinChiDTO ltc){
// int x = lopTinChiService.themLTC(ltc.getMamh(), ltc.getMalop(),
// ltc.getMagv(), ltc.getNienkhoa(), ltc.getNhom(), ltc.getSosvtt(),
// ltc.getSosvtd(), ltc.getHocki(), ltc.getMakhoa());
// if(x == 1)
...
// public ResponseEntity<LopTinChiDTO> updateLTC(@Validated @RequestBody
// LopTinChiDTO ltc){
// int x = lopTinChiService.updateLTC(ltc.getMaltc(), ltc.getMagv(),
// ltc.getNhom(), ltc.getSosvtt(), ltc.getSosvtd());
// if(x == 1)
// return new ResponseEntity<>(ltc, HttpStatus.OK);
// return new ResponseEntity<>(ltc, HttpStatus.BAD_REQUEST);
// }
