...
// public ResponseEntity<SinhVien> thongTinCaNhan(@RequestParam("ma-sv") String
// maSV){
...
// public ResponseEntity<SinhVienDTO> timSinhVien(@RequestParam("ma-sv") String
// masv) {
// SinhVien sv = sinhVienService.sinhVienTheoMa(masv);

// SinhVienDTO sinhVienDTO = (new SinhVienDTO(sv.getMasv(), sv.getHo(),
// sv.getTen(),sv.getPhai(),sv.getDiachi(),sv.getNgaysinh(),sv.getMalop().getMalop(),sv.getDanghihoc(),sv.getSdt(),sv.getHinhanh(),sv.getEmail()));

// return ResponseEntity.ok(sinhVienDTO);
// }

// @GetMapping("/danh-sach-sv-lop")
// public ResponseEntity<List<SinhVienDTO>>
// danhSachSVLop(@RequestParam("ma-lop") String malop) {
...
// DSSV.add(new SinhVienDTO(sv.getMasv(), sv.getHo(),
// sv.getTen(),sv.getPhai(),sv.getDiachi(),sv.getNgaysinh(),sv.getMalop().getMalop(),sv.getDanghihoc(),sv.getSdt(),sv.getHinhanh(),sv.getEmail()));
// }
...
// public ResponseEntity<Map<String, Object>> themSinhVien(@RequestParam("sv")
// String svString,
...
// public ResponseEntity<Map<String, Object>> updateSV(@RequestParam("sv")
// String svString,
// @RequestParam("img") MultipartFile file) throws IOException {
// Map<String, Object> result = new HashMap<>();
// ObjectMapper objectMapper = new ObjectMapper();
...
// public ResponseEntity<?> updateSinhVien(@Validated @RequestBody SinhVienDTO
// sinhvien){
// if(sinhVienService.updateSinhVien(sinhvien) == 0){
// return ResponseEntity.badRequest().build();
// } else {
...
// public ResponseEntity<?> updateDaNghiHoc(@Validated @RequestParam("masv")
// String masv)
// {
...
// getImageDynamicType(@RequestParam("name") String name) {
...
// private ResponseEntity<?> thongTinCaNhanSV(@RequestParam("ma-sv") String
// maSV){
...
// List<List<DiemResponse>> listDiem = sinhVienService.xemDiem(maSV);
// if(listDiem != null){
...
// return new ResponseEntity<>(sinhVienService.getNienKhoaHocKi(maSV),
// HttpStatus.OK);
// }
// >>>>>>> 40eaf51c3a43a021ba550ae9735e7d041aa22ced
// }
